                    ...
                    <tr class="border-b-2 border-blue-300 mt-3">
                        ...
                        <td>
                            <form action="{{ route('cart.destroy', $item) }}" method="POST" id="form2" name="form2">
                                @csrf
                                @method('DELETE')
                                <button type="submit" onclick="submit()" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Cancel</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
